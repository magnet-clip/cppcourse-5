...
void Compare(istream& actual, istream& expected) {
  string a, e;
...
void RunAndValidate(const string& input_file, const string& output_file) {
  ...
  stringstream out;
  Run(f_input, out);
  Compare(out, f_output);
}

void Test1() {
  cout << "Test1" << endl;
  RunAndValidate("input-1.txt", "output-1.txt");
}
